...
READERS: Dict[str, ReaderType] = {
    ...
    'orc': lambda path, conv: pl.scan_parquet(conv.orc_to_csv(path)),
    'xlsx': lambda path, conv: pl.scan_parquet(conv.excel_to_csv(path)),
    'xls': lambda path, conv: pl.scan_parquet(conv.excel_to_csv(path)),
    'xlsm': lambda path, conv: pl.scan_parquet(conv.excel_to_csv(path)),
    'xlsb': lambda path, conv: pl.scan_parquet(conv.excel_to_csv(path)),
    'odf': lambda path, conv: pl.scan_parquet(conv.excel_to_csv(path)),
    'ods': lambda path, conv: pl.scan_parquet(conv.excel_to_csv(path)),
    'odt': lambda path, conv: pl.scan_parquet(conv.excel_to_csv(path)),
    'feather': lambda path, conv: pl.scan_parquet(conv.feather_to_csv(path)),
    'sas7bdat': lambda path, conv: pl.scan_parquet(conv.sas_to_csv(path, encoding='utf-8')),
    'xpt': lambda path, conv: pl.scan_parquet(conv.xpt_to_csv(path)),
    'xml': lambda path, conv: pl.scan_parquet(conv.xml_to_csv(path)),
    'sav': lambda path, conv: pl.scan_parquet(conv.spss_to_csv(path)),
    'zsav': lambda path, conv: pl.scan_parquet(conv.spss_to_csv(path)),
    'dta': lambda path, conv: pl.scan_parquet(conv.stata_to_csv(path, convert_categoricals=False)),
    'h5': lambda path, conv: pl.scan_parquet(conv.hdf_to_csv(path)),
    'hdf5': lambda path, conv: pl.scan_parquet(conv.hdf_to_csv(path)),
    'por': lambda path, conv: pl.scan_parquet(conv.por_to_csv(path)),
    'sdf': lambda path, conv: pl.scan_parquet(conv.sdf_to_csv(path)),
    'pkl': lambda path, conv: pl.scan_parquet(conv.pkl_to_csv(path)),
}
...
WRITERS: Dict[str, WriterType] = {
    ...
    'pkl': lambda result, path: result.to_pandas().to_pickle(path),
}
