...
// Select commands
const commandSet = process.platform === 'win32' ? commands.win32 : commands.unix;
...
try {
  ...
  stdout = execSync(`${commandSet.pipPath} install -r requirements.txt`, { stdio: 'pipe' }).toString();
  console.log(`Packages installed.\n${stdout}`);

  // Build python bin
  stdout = execSync(`${commandSet.pythonPath} setup.py build`, { stdio: 'pipe' }).toString();
